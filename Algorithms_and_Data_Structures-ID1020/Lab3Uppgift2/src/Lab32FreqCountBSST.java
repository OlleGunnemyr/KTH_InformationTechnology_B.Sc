 ...
 * Name:	 Olle Gunnemyr
 * Date:	 2020-09-28
 * Program:	 Lab32FreqCountBSST.java
 * 
 * Lab32FreqCountBSST.java counts the frequency of occurrence of N (in the order of hundred) words larger than the minimum size minlen. The user decides both N and minlen.
 * The program prints out the word that occurs the most, along with the execution time of the insertion in the ordered array symbol table (BinarySearchST). 
 * 
...
import edu.princeton.cs.algs4.BinarySearchST;//the Ordered Array ST


public class Lab32FreqCountBSST {
